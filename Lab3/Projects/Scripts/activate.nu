...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'E:\Конструюваня програмного забезпечення\Project'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'E:\Конструюваня програмного забезпечення\Project\Scripts\deactivate.nu'
