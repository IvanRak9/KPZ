...
first_generation_virus = Virus(10, 1, "First Virus", "Alpha")
second_generation_virus = Virus(12, 2, "Second Virus", "Beta")
third_generation_virus = Virus(15, 3, "Third Virus", "Gamma")
